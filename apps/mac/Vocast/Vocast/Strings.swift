...
struct Strings {
    ...
    static let en: [String: String] = [
        ...
        "libNoResults": "No narrations match your search.",
        "narrationSpeedLabel": "~{x}x slower than realtime",
        ...
        "libSoon": "Coming soon.",
        "libDuplicateSuffix": " copy",
        "toNarrationDeleted": "Narration deleted.",
        "toNarrationDuplicated": "Narration duplicated.",
        "toNarrationImported": "Narration imported.",
    ...
    static let ko: [String: String] = [
        ...
        "libEmptyCta": "새 나레이션",
        "libNoResults": "검색과 일치하는 나레이션이 없어요.",
        "narrationSpeedLabel": "실시간의 약 {x}배 느림",
        ...
        "libSoon": "곧 지원돼요.",
        "libDuplicateSuffix": " 복사본",
        "toNarrationDeleted": "나레이션을 삭제했어요.",
        "toNarrationDuplicated": "나레이션을 복제했어요.",
        "toNarrationImported": "나레이션을 가져왔어요.",
        "errOpenNarration": "나레이션을 열 수 없어요.",
        "errExport": "내보내기에 실패했어요.",
        "errImport": "가져오기에 실패했어요.",
        "relJustNow": "방금",
